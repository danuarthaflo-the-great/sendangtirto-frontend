...
<div class="page-content">
  ...
  <section class="section-dark" style="min-height: 50vh;">
    <div class="breadcrumb fu">
      <a href="index.php" style="color:var(--putih);opacity:0.8">Beranda</a>
      <span style="color:var(--putih);opacity:0.8">›</span>
